...
export const DIMENSION_META = {
  RE: {
    ...
    high: '体力守门员',
    analysis: {
      L: '你对体力和日常的态度比较松，账号更多是跟着心情走，不太会被“别溢出”这种提醒持续绑架。',
      M: '你对日常资源有基本管理意识，通常不会完全摆烂，但也不会把自己逼成提瓦特考勤机器。',
      H: '你对体力和每日流程有很强的敏感度。哪怕嘴上说佛，行动上也很像一个会主动巡逻账号状态的人。',
    },
  },
  GA: {
    label: '卡池冲动',
    ...
    high: '按钮磁铁',
    analysis: {
      L: '你在祈愿这件事上相对能忍，通常不会被临时情绪轻易推着走。',
      M: '你不算完全理性，但大多数时候还能在“想抽”和“再看看”之间留一点缓冲。',
      H: '你对卡池的情绪反应很快，嘴上说考虑一下，身体通常已经准备点十连了。',
    },
  },
  PR: {
    label: '强度执念',
    ...
    high: '少一星难眠',
    analysis: {
      L: '你对练度和通关结果的要求偏宽松，更多是为了玩得顺手，不太会把自己卷进死循环。',
      M: '你会在意环境和强度，但不至于时时刻刻为此焦虑，属于有标准但还能放过自己。',
      H: '你很容易把“差一点”放大成一件事。对你来说，强度不只是效率问题，也关系到一点点自我证明。',
    },
  },
  LO: {
    label: '设定投入',
    ...
    high: '文本洁癖',
    analysis: {
      L: '你对剧情和设定的投入偏低，更重视体验节奏本身，不太愿意长时间停在文本里。',
      M: '你会认真对待主线和关键角色，但不会把每一条文本都当作必须逐句精读的材料。',
      H: '你对设定连续性和文本细节很敏感。别人随口一聊可能只是聊天，你听到的却是“这里讲得不严谨”。',
    },
  },
  EX: {
    label: '探索执念',
    ...
    high: '99% 不算人',
    analysis: {
      L: '你对探索完成度的执念较低，更多是顺路拿奖励，不会长期被百分比拿捏。',
      M: '你对地图清理有一定要求，通常会在空的时候补一补，但还能接受暂时留白。',
      H: '你很难忍受“差一点”。对你来说，探索不是随便走走，而是要把遗留问题真正清干净。',
    },
  },
  SO: {
    label: '联机热心',
    ...
    high: '世界售后',
    analysis: {
      L: '你更偏向一个人处理游戏内容，联机不是必需品，甚至偶尔会让你觉得费神。',
      M: '你对社交和联机持开放态度，但通常会看关系和场合，不会无差别接活。',
      H: '你很容易对别人的求助产生反应。哪怕不是最强的那个，你也常常会自然站到“那我来吧”的位置上。',
    },
  },
  XP: {
    label: 'XP浓度',
    ...
    high: '顺眼就冲',
    analysis: {
      L: '你对角色的判断偏实际，会优先考虑环境、成本和投入产出，不太会单靠喜欢就直接下决定。',
      M: '你在理性和偏爱之间切换得比较自然，有时会算强度，有时也会为了喜欢稍微让步。',
      H: '你对角色的情感判断优先级很高。强度不是不重要，只是通常排在“我喜欢”后面。',
    },
  },
  CH: {
    label: '抽象指数',
    ...
    high: '自带节目',
    analysis: {
      L: '你整体还是偏稳的，不太主动制造节目效果，更像普通玩家的常规游玩轨迹。',
      M: '你平时看着还算正常，但状态一上来就容易开始说怪话、玩怪套路或者做点抽象操作。',
      H: '你有很强的整活和发病气质。哪怕不是刻意搞事，很多场合也会在你这儿自然长出一点节目效果。',
    },
  },
}
