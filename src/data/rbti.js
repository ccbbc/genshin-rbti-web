...
export const DIMENSION_META = {
  RE: {
    ...
    high: '体力守门员',
    analysis: {
      L: '对体力这件事比较随缘。你不是完全不管，只是很少把“别溢出”当成必须立刻处理的大事，游戏更多还是跟着心情走。',
      M: '对日常流程有基本管理意识。你通常知道自己该做什么，也能维持账号在一个还不错的状态，但不会把自己活成提瓦特考勤员。',
      H: '对体力和每日刷新很敏感，账号状态基本都在心里有数。哪怕嘴上说随便，行动上也很像一个会主动巡逻自己账号的人。',
    },
  },
  GA: {
    label: '卡池冲动',
    ...
    high: '按钮磁铁',
    analysis: {
      L: '抽卡前相对克制，不太会被一时情绪直接推着走。你通常会先观察、先权衡，再决定这次到底值不值得自己下场。',
      M: '会心动，也会犹豫。你不是完全冷静的人，但大多数时候还能在“现在就抽”和“再看看”之间给自己留一点缓冲。',
      H: '对卡池反应很快，情绪起得也快。你往往脑子还在想，身体已经开始往祈愿页靠，很多决定都是在上头那一刻完成的。',
    },
  },
  PR: {
    label: '强度执念',
    ...
    high: '少一星难眠',
    analysis: {
      L: '对练度和结果要求偏宽，能顺手玩下去就已经够了。你更在意体验是否流畅，而不是非要把每个数值都抠到最理想。',
      M: '会在意环境和配装，也会希望自己的账号别太拉垮，但通常还能把自己从焦虑里拉出来，不至于一直跟“差一点”较劲。',
      H: '很难接受“差一点”。强度对你来说不只是效率问题，还带着一点自我要求和胜负心，所以少一星、少一点伤害都容易被你放大。',
    },
  },
  LO: {
    label: '设定投入',
    ...
    high: '文本洁癖',
    analysis: {
      L: '对文本投入偏低，更在意流程顺不顺，不太愿意在设定里停太久。剧情对你来说是体验的一部分，但不是你最主要的乐趣来源。',
      M: '主线和关键设定会认真看，重要角色和核心信息基本不会错过，但也不会把所有支线、物件文本都当成必须精读的内容。',
      H: '对设定连续性和文本细节很敏感。你不只是“爱看剧情”，而是很容易记住前后逻辑，一旦听到别人聊歪，心里会本能地想纠正。',
    },
  },
  EX: {
    label: '探索执念',
    ...
    high: '99% 不算人',
    analysis: {
      L: '对探索完成度要求不高，差一点通常也不会太放在心上。你更像是顺路开、顺路拿，不太会为了一个百分比长期惦记。',
      M: '会想补地图，也会在空的时候顺手清一清，但大多数时候还能接受“先留着，以后再说”。探索对你来说是持续推进，不是立刻归零。',
      H: '很难忍受“差一点”。探索在你这里通常要有个干净结果，所以 99% 不会被你当成完成，而会被你当成一个还没解决的问题。',
    },
  },
  SO: {
    label: '联机热心',
    ...
    high: '世界售后',
    analysis: {
      L: '更习惯一个人处理内容，联机不是刚需。你不是讨厌别人，只是很多游戏体验你更愿意自己掌控节奏。',
      M: '对联机持开放态度，但会看人和场合，不会谁都接。熟人、合适的时机和明确的目的，通常比单纯“来不来”更重要。',
      H: '对别人的求助反应很快，很容易自然接过“那我来吧”这个位置。你在联机里经常会不自觉地承担照应、带人和收尾的角色。',
    },
  },
  XP: {
    label: 'XP浓度',
    ...
    high: '顺眼就冲',
    analysis: {
      L: '对角色判断偏实际，通常会先想值不值，再想喜不喜欢。你的喜爱当然存在，但大多时候不会压过资源投入和长期规划。',
      M: '会在理性和偏爱之间来回权衡，两边都不是完全压倒性的。你既懂“为了喜欢破例”的快乐，也知道“先别冲动”的必要。',
      H: '对角色的喜欢优先级很高，很多时候“顺眼”就已经足够。你不是不懂环境，只是比起别人告诉你该抽谁，你更相信自己心里的那一下反应。',
    },
  },
  CH: {
    label: '抽象指数',
    ...
    high: '自带节目',
    analysis: {
      L: '整体偏稳，不太主动制造节目效果。你的游戏方式更接近日常玩家的常规轨迹，通常不会特意把场面往抽象方向带。',
      M: '平时看着正常，但状态一上来就容易开始整点怪的。你不是时时刻刻都在发病，只是很多时候乐子和抽象感会突然冒出来。',
      H: '抽象和整活气质很明显，很多场合到你这儿都会自己长出节目效果。你不一定刻意搞事，但你很容易把原本普通的体验玩出一点离谱味。',
    },
  },
}
