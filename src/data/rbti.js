...
export const DIMENSION_META = {
  RE: { label: '树脂纪律', low: '随缘活着', mid: '看情况清', high: '体力守门员' },
  GA: { label: '卡池冲动', low: '相当克制', mid: '偶尔上头', high: '按钮磁铁' },
  PR: { label: '强度执念', low: '能玩就行', mid: '看情况卷', high: '少一星难眠' },
  LO: { label: '设定投入', low: '能跳就跳', mid: '主线认真', high: '文本洁癖' },
  EX: { label: '探索执念', low: '差不多就行', mid: '有空会清', high: '99% 不算人' },
  SO: { label: '联机热心', low: '单机安静', mid: '看熟不熟', high: '世界售后' },
  XP: { label: 'XP浓度', low: '比较理性', mid: '偶尔为爱', high: '顺眼就冲' },
  CH: { label: '抽象指数', low: '比较正常', mid: '偶尔犯病', high: '自带节目' },
}
